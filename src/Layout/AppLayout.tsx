...
export function AppLayout() {
    return (
        <div style={{ fontFamily: "Afacad Flux" }} className="h-screen w-full flex bg-[#a9dfbf41] text-xl">
            <div className="w-[200px] mt-5 ml-5">
                ...
                <nav className="flex flex-col gap-y-5">
                    <a href="/" className="flex items-center gap-x-3 text-gray-500 hover:text-[#228B22]">
                        <span>
                    ...
                    <a href="/reports" className="flex items-center gap-x-3 text-gray-500 hover:text-[#228B22]">
                        <span>
                    ...
                    <a href="companies" className="flex items-center gap-x-3 text-gray-500 hover:text-[#228B22]">
                        <span>
                    ...
                    <a href="/trends" className="flex items-center gap-x-3 text-gray-500 hover:text-[#228B22]">
                        <span>
                    ...
                    <a href="/ratios" className="flex items-center gap-x-3 text-gray-500 hover:text-[#228B22]">
                        <span>
                    ...
                    <a href="/files" className="flex items-center gap-x-3 text-gray-500 hover:text-[#228B22]">
                        <span>
            ...
            <main className="flex-1 rounded-lg overflow-y-scroll shadow-xl mt-2 bg-[#f5f8f9] p-5">
                <Outlet/>
            </main>
        </div>
    )
