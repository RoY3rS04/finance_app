...
export function AppLayout({children}) {
    ...
    function verifyActivePage() {
        ...
        } else if (currentLocation === '/accounts') {
            setActivePages(prev => ({
                home: false,
                periods: false,
                accounts: true
        ...
        <div className='flex min-h-screen bg-[#f5f8f9] relative' style={{ fontFamily: "Afacad Flux" }}>
            <aside className={`${!isCollapsed ? 'w-[250px]' : 'w-20 items-center'} flex flex-col p-5 gap-y-10 transition-all ease-in duration-300 relative`}>
                ...
                <nav className={`flex flex-col ${!isCollapsed ? '' : 'items-center'} gap-y-5 text-lg`}>
                    <Link className={`flex items-center gap-x-2 ${activePages.home ? 'text-[#228B22]': 'text-gray-500'} hover:text-[#228B22]`} href="/">
                    ...
                    <Link className={`flex items-center gap-x-2 ${activePages.periods ? 'text-[#228B22]': 'text-gray-500'} hover:text-[#228B22]`} href="/periods">
                    ...
                    <Link className={`flex items-center gap-x-2 ${activePages.accounts ? 'text-[#228B22]': 'text-gray-500'} hover:text-[#228B22]`} href="/accounts">
